package com.two.factor.authentication.appl.model.employee;
...
public class Employee {
    ...
    public int getSecretPhraseId() {
        return secretPhraseId;
    }

    public void setSecretPhraseId(int secretPhraseId) {
        this.secretPhraseId = secretPhraseId;
    }
}
