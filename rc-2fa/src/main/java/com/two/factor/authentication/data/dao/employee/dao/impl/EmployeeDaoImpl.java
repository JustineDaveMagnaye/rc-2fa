package com.two.factor.authentication.data.dao.employee.dao.impl;
...
import static com.two.factor.authentication.data.utils.EmployeeQueryConstants.*;
...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    @Override
    public Employee getEmployeeById(String employeeNo) {
        Employee employee = null;

        try (Connection connection = ConnectionHelper.getConnection())
        {
            PreparedStatement preparedStatement = connection.prepareStatement(GET_EMPLOYEE_BY_ID_STATEMENT);
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    employee.setSecretPhraseId(resultSet.getInt("secret_phrase_id"));
                    return employee;
                }
            }
        } catch (Exception e) {
    ...
    public boolean addEmployee(Employee employee) {
        try (Connection connection = ConnectionHelper.getConnection()){
            ...
            stmt.setInt(18, employee.getLoginId());
